...
#define ESP_LV_ADAPTER_FBCPY_PIXEL_FORMAT(bytes_per_pixel) \
    .pixel_format_fourcc_id = ((bytes_per_pixel) == COLOR_BYTES_RGB565 ? ESP_COLOR_FOURCC_RGB16 : ESP_COLOR_FOURCC_RGB24)
#else
#define ESP_LV_ADAPTER_FBCPY_PIXEL_FORMAT(bytes_per_pixel) \
    .pixel_format_unique_id = { \
        .color_type_id = ((bytes_per_pixel) == COLOR_BYTES_RGB565) ? \
    ...
    uint8_t* color_map)
{
    ...
    esp_async_fbcpy_trans_desc_t blit = {
        ...
        .copy_size_x = rect_w,
        .copy_size_y = rect_h,
        ESP_LV_ADAPTER_FBCPY_PIXEL_FORMAT(lvgl_color_format_bytes),
    };
...
static void copy_unrendered_area_from_front_to_back(lv_disp_t* disp_refr, esp_lv_adapter_display_bridge_v8_t* impl)
{
    ...
    for (int idx = 0; idx < unsync_cnt; idx++)
    {
        ...
        esp_async_fbcpy_trans_desc_t tr = {
            ...
            ESP_LV_ADAPTER_FBCPY_PIXEL_FORMAT(color_bytes),
        };
