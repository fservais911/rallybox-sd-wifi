...
#define BSP_LCD_IN_COLOR_FORMAT_RGB565 ESP_COLOR_FOURCC_RGB16
#define BSP_LCD_IN_COLOR_FORMAT_RGB888 ESP_COLOR_FOURCC_RGB24
#else
#define BSP_LCD_IN_COLOR_FORMAT_RGB565 LCD_COLOR_FMT_RGB565
#define BSP_LCD_IN_COLOR_FORMAT_RGB888 LCD_COLOR_FMT_RGB888
#endif
...
static bool s_backlight_skip_warned = false;
...
{
#if CONFIG_BSP_LCD_TYPE_720_1280_7_INCH
    /* The 7-inch profile can report LEDC pin conflicts for GPIO26 on some carrier variants.
     * Use a GPIO on/off fallback so backlight remains functional. */
    gpio_config_t backlight_gpio_cfg = {
    ...
    BSP_ERROR_CHECK_RETURN_ERR(gpio_config(&backlight_gpio_cfg));

    s_backlight_pwm_enabled = false;
    brightness = 100;
    gpio_set_level(BSP_LCD_BACKLIGHT, 1);

    if (!s_backlight_skip_warned)
    {
        ESP_LOGW(TAG, "Using GPIO fallback for 7-inch backlight (LEDC disabled)");
        s_backlight_skip_warned = true;
    }
    return ESP_OK;
#endif
...
esp_err_t bsp_display_new_with_handles(const bsp_display_config_t* config, bsp_lcd_handles_t* ret_handles)
{
    ...
    esp_lcd_dpi_panel_config_t dpi_config = JD9365_800_1280_PANEL_60HZ_DPI_CONFIG_CF(BSP_LCD_IN_COLOR_FORMAT_RGB888);
#else
    esp_lcd_dpi_panel_config_t dpi_config = JD9365_800_1280_PANEL_60HZ_DPI_CONFIG_CF(BSP_LCD_IN_COLOR_FORMAT_RGB565);
#endif
    ...
    esp_lcd_dpi_panel_config_t dpi_config = {
        ...
        .virtual_channel = 0,
#if CONFIG_BSP_LCD_COLOR_FORMAT_RGB888
        .in_color_format = BSP_LCD_IN_COLOR_FORMAT_RGB888,
#else
        .in_color_format = BSP_LCD_IN_COLOR_FORMAT_RGB565,
#endif
...
esp_err_t bsp_touch_new(const bsp_display_cfg_t* cfg, esp_lcd_touch_handle_t* ret_touch)
{
    ...
    // CRITICAL: Set extremely low I2C speed to handle high bus capacitance / noise
    tp_io_config.scl_speed_hz = 50000;
